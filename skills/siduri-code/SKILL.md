...
- **FO-19** **Artefact pass find class of defect where every copy is individually correct.** Operator found two site chrome, three post-meta, two content width in five minute. No gate see it: each copy internally consistent and pass alone. This is *why* `FO-10a`, not restatement of it.
